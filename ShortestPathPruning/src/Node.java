...
public class Node  {
			...
			// case 2 we have 1 included edge
				...
				for(int j = 0; j < value_matric_col; j++){
					...
					if(getIe_matric()[i][j] == 1){
						total = total + m_value_matric[i][j];
					}
	...
	public void setM_completecycle(boolean m_completecycle) {
		this.m_completecycle = m_completecycle;
	}
